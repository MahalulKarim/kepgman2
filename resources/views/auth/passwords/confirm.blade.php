...
<head>
    ...
    <title>Confirm Password — MAN 2 Krasak</title>
        ...
        <div class="col-12 col-md-6 col-lg-5 d-flex align-items-center justify-content-center bg-white p-4 p-sm-5">
            <div class="w-100" style="max-width: 400px;">
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="row mb-3 input-group-custom">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary btn btn-success py-2.5 fw-bold shadow-sm rounded">
                                    {{ __('Confirm Password') }}
                                </button>
