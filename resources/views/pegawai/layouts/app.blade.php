...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 d-flex h-100 bg-white" style="width: 18%;height: 100vh!important;position: fixed;">
    ...
    <a href="{{ route('pegawai.dashboard') }}" class="text-center text-decoration-none text-dark">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item text-center">
        <a href="{{ route('pegawai.dashboard') }}" class="nav-link text-dark {{($title=='Dashboard')? 'active':''}}" aria-current="page">
          Dashboard
        </a>
      </li>

       <li class="nav-item text-center">
        <a href="{{ route('pegawai.kegiatan.index') }}" class="nav-link text-dark {{($title=='Kegiatan')? 'active':''}}" aria-current="page">
          Kegiatan Harian
        </a>
      </li> 
       <li class="nav-item text-center">
        <a href="{{ route('pegawai.pegawai.index') }}" class="nav-link text-dark {{($title=='Data Diri')? 'active':''}}" aria-current="page">
          Data Diri
        </a>
      </li> 
       <li class="nav-item text-center">
      <a href="{{ route('pegawai.jabatan.index') }}" class="nav-link text-dark {{($title=='Jabatan')? 'active':''}}" aria-current="page">
          Riwayat Jabatan
        </a>
      </li>
      <li class="nav-item text-center">
        <a href="{{ route('pegawai.pendidikan.index') }}" class="nav-link text-dark {{($title=='Riwayat Pendidikan')? 'active':''}}" aria-current="page">
          Data Riwayat Pendidikan / Pelatihan
        </a>
      </li>
      <li class="nav-item text-center">
        <a href="{{ route('pegawai.pensiun.index') }}" class="nav-link text-dark {{($title=='Pensiun')? 'active':''}}" aria-current="page">
          Data Pensiun
        </a>
      </li>
