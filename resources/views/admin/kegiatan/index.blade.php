    ...
    <div class="row pt-2">
        <div class="col-lg-12">
            ...
            <div class="col-12 col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('admin.kegiatan.index') }}" class="btn btn-sm btn-light  text-secondary border fw-semibold">
                    Reset
                </a>
            </div>
        </form>
                                     ...
                                     <td class="text-center pe-3">
                                         <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                             ...
                                             <form action="{{ route('admin.kegiatan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus catatan kegiatan harian ini?')">
                                                 @csrf
                                                 @method('DELETE')
...
function cetakPdfFiltered() {
    ...
    let url = "{{ route('admin.kegiatan.cetak') }}";
