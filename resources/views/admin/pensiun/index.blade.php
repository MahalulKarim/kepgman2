                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_pensiun" class="form-control form_border" required>
                        </div>
                        <div class="col-md-6">
            ...
            <form id="formEdit" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">TMT Pensiun</label>
                            <input type="date" id="edit_tanggal_pensiun" name="tanggal_pensiun" class="form-control form_border" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Masa Kerja</label>
