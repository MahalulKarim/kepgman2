...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 d-flex h-100 bg-white" style="width: 18%;height: 100vh!important;position: fixed;">
    ...
    <a href="{{ route('admin.dashboard') }}" class="text-center text-decoration-none text-dark">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      {{-- <li class="nav-item text-center">
        <a href="#" class="nav-link text-dark {{($title=='Dashboard')? 'active':''}}" aria-current="page">
          Dashboard
        </a>
      </li> --}}
      <li class="nav-item text-center">
       ...
       <li class="nav-item text-center">
        <a href="{{ route('admin.kegiatan.index') }}" class="nav-link text-dark {{($title=='Kegiatan')? 'active':''}}" aria-current="page">
