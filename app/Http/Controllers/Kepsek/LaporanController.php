...
class LaporanController extends Controller
{
    ...
    public function index()
    {
        ...
        $jabatan = Jabatan::get();
        $riwayatPendidikan = RiwayatPendidikan::with('user.pegawai')->get();
        $pensiun = Pensiun::with('user.pegawai')->get();
        $kegiatan = Pegawai::with('kegiatan');


        return view('kepsek.laporan.index',compact('pegawai','jabatan','riwayatPendidikan','pensiun','kegiatan'));
    }
...
public function cetakPdf(Request $request)
    ...
    elseif ($jenis == 'kegiatan') {
        ...
        $pdf = Pdf::loadView('kepsek.laporan.cetak_pdf', $pdfData)->setPaper('a4', 'landscape');
