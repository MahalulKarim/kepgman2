...
class PegawaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $pegawai = Pegawai::with('jabatan','user')->where('user_id', Auth::id())->first();
        return view('pegawai.pegawai.index', compact('pegawai','jabatan'));
    }
    ...
    public function store(Request $request)
    {
       ...
       $namaFoto = null;
        ...
        return redirect()->route('pegawai.pegawai.index')->with('success', 'Data pegawai berhasil ditambahkan.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pegawai.pegawai.index')->with('success', 'Data pegawai berhasil dihapus.');
    }
}
